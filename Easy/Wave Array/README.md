<h2><a href="https://www.geeksforgeeks.org/problems/wave-array-1587115621/1?page=1&company=Amazon&difficulty=Easy&status=unsolved&sprint=ca8ae412173dbd8346c26a0295d098fd&sortBy=submissions">Wave Array</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a <strong>sorted</strong> array <strong>arr[]</strong>&nbsp;of distinct integers. Sort the array into a wave-like array(In Place).<br>In other words, arrange the elements into a sequence such that arr[1] &gt;= arr[2] &lt;= arr[3] &gt;= arr[4] &lt;= arr[5].....</span></p>
